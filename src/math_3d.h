...
//#ifndef _DEBUG
//#define LINKAGE_DECL static inline
//#else
//#define LINKAGE_DECL
//#endif
...
LINKAGE_DECL vec3_t vec3(float x, float y, float z)        { return (vec3_t){ x, y, z }; }

LINKAGE_DECL vec3_t v3_add   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x + b.x, a.y + b.y, a.z + b.z }; }
LINKAGE_DECL vec3_t v3_adds  (vec3_t a, float s)           { return (vec3_t){ a.x + s,   a.y + s,   a.z + s   }; }
LINKAGE_DECL vec3_t v3_sub   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x - b.x, a.y - b.y, a.z - b.z }; }
LINKAGE_DECL vec3_t v3_subs  (vec3_t a, float s)           { return (vec3_t){ a.x - s,   a.y - s,   a.z - s   }; }
LINKAGE_DECL vec3_t v3_mul   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x * b.x, a.y * b.y, a.z * b.z }; }
LINKAGE_DECL vec3_t v3_muls  (vec3_t a, float s)           { return (vec3_t){ a.x * s,   a.y * s,   a.z * s   }; }
LINKAGE_DECL vec3_t v3_div   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x / b.x, a.y / b.y, a.z / b.z }; }
LINKAGE_DECL vec3_t v3_divs  (vec3_t a, float s)           { return (vec3_t){ a.x / s,   a.y / s,   a.z / s   }; }
LINKAGE_DECL float  v3_length(vec3_t v)                    { return sqrtf(v.x*v.x + v.y*v.y + v.z*v.z);          }
LINKAGE_DECL vec3_t v3_norm  (vec3_t v);
LINKAGE_DECL float  v3_dot   (vec3_t a, vec3_t b)          { return a.x*b.x + a.y*b.y + a.z*b.z;                 }
LINKAGE_DECL vec3_t v3_proj  (vec3_t v, vec3_t onto);
LINKAGE_DECL vec3_t v3_cross (vec3_t a, vec3_t b);
LINKAGE_DECL float  v3_angle_between(vec3_t a, vec3_t b);
...
LINKAGE_DECL mat4_t m4_identity     ();
LINKAGE_DECL mat4_t m4_translation  (vec3_t offset);
LINKAGE_DECL mat4_t m4_scaling      (vec3_t scale);
LINKAGE_DECL mat4_t m4_rotation_x   (float angle_in_rad);
LINKAGE_DECL mat4_t m4_rotation_y   (float angle_in_rad);
LINKAGE_DECL mat4_t m4_rotation_z   (float angle_in_rad);
...
LINKAGE_DECL mat4_t m4_transpose    (mat4_t matrix);
LINKAGE_DECL mat4_t m4_mul          (mat4_t a, mat4_t b);
