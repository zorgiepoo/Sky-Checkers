...
#define TILE_DIEING_STONE_SOUND_VOLUME	16
...
#define LOWER_AUDIO_DIVIDER 4
void setLowerAudioVolume(void)
{
	Mix_VolumeMusic(MUSIC_VOLUME / LOWER_AUDIO_DIVIDER);
	Mix_Volume(MENU_SOUND_CHANNEL, MENU_SOUND_VOLUME / LOWER_AUDIO_DIVIDER);
	setVolume(SHOOTING_SOUND_VOLUME / LOWER_AUDIO_DIVIDER, SHOOTING_SOUND_MIN_CHANNEL, SHOOTING_SOUND_MAX_CHANNEL);
	setVolume(TILE_FALLING_SOUND_VOLUME / LOWER_AUDIO_DIVIDER, TILE_FALLING_SOUND_MIN_CHANNEL, TILE_FALLING_SOUND_MAX_CHANNEL);
	setVolume(TILE_DIEING_STONE_SOUND_VOLUME / LOWER_AUDIO_DIVIDER, DIEING_STONE_SOUND_MIN_CHANNEL, DIEING_STONE_SOUND_MAX_CHANNEL);
}
