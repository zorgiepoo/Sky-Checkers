...
Sky Checkers officially supports macOS, Windows, and Linux. Support for other platforms depends the presence of [SDL](https://www.libsdl.org). Downloads for version 1.0.2 can be found on the [releases page](https://github.com/zorgiepoo/Sky-Checkers/releases). For information on compiling the latest changes from source, please see [INSTALL](INSTALL).
